          ...
          <div className="lg:col-span-7">
            ...
            >
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white tracking-tight mb-6 leading-tight font-sans">
                Machine Learning with <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400">Python</span>
              </h1>
            ...
            >
              <div className="flex items-center justify-between mb-6 border-b border-slate-700 pb-4">
                ...
                <span className="text-sm text-slate-300">
                  Course starts: <span className="text-white font-medium">27 Jun 2026</span>
                </span>
              </div>             
              <div className="space-y-6 text-slate-300">
                ...
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm leading-relaxed text-white">Live instruction, Jupyter-based labs, Kaggle challenges, and project presentations</p>
                  </div>
                </div>
              </div>
            </motion.div>
