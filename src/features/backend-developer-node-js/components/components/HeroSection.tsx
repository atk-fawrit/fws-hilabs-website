          ...
          <div className="lg:col-span-7">
            ...
            >
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white tracking-tight mb-6 leading-tight font-sans">
                Backend Developer <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400">(Node.js)</span>
              </h1>
            ...
            >
                <div className="flex items-center justify-between mb-6 border-b border-slate-700 pb-4">
                  ...
                  <span className="text-sm text-slate-300">
                    Course starts: <span className="text-white font-medium">6 Jun 2026</span>
                  </span>
                </div>              
                ...
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm leading-relaxed text-white">Instructor-led sessions, real-world API projects, and technical assessments</p>
                  </div>
                </div>
              </div>
            </motion.div>
