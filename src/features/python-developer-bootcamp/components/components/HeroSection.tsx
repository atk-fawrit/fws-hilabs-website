          ...
          <div className="lg:col-span-7">
            ...
            >
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white tracking-tight mb-6 leading-tight font-sans">
                Python Developer <span className="text-white">Bootcamp</span>
              </h1>
              ...
              <div className="space-y-6 text-gray-300">
                ...
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm leading-relaxed text-white">Instructor-led live sessions, hands-on projects, coding challenges, and peer reviews</p>
                  </div>
                </div>
              </div>
            </motion.div>
