          ...
          <div className="lg:col-span-7">
            ...
            >
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white tracking-tight mb-6 leading-tight font-sans">
                QA & Test <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400">Automation</span>
              </h1>
              <p className="text-lg md:text-xl text-slate-300 mb-8 max-w-2xl leading-relaxed">
                Ensure software quality at scale through systematic testing and intelligent automation.
              </p>
              ...
              <div className="space-y-6 text-slate-300">
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm leading-relaxed">12 Weeks | Full-Time & Part-Time options available</p>
                  </div>
                </div>
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm leading-relaxed">Live sessions, testing labs, automation frameworks, and project-based assessments</p>
                  </div>
                </div>
              </div>
            </motion.div>
