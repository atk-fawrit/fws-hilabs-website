 ...
 * 
 * Centralized data for program sections and content
 */
...
export const programSections = [
  {
    ...
    description: 'Comprehensive program structure, constraints, and elimination criteria defining the systematic engineering talent development framework',
