...
import { inputStyle, labelStyle, errorStyle } from "../../styles/ProgramOverviewSection.styles";
    ...
    <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: "5px" }}>
      <div
        style={{
          ...
          fontSize: "21px", fontWeight: 800, letterSpacing: "-0.05em",
        }}
      >
...
const statItems = [
  {
    label: "Location", value: "In-Person - Lucknow",
    icon: (
  ...
  {
    label: "Batch Size", value: "30 students per batch",
    icon: (
      <svg width="14" height="14" fill="none" stroke="rgba(255,255,255,.5)" viewBox="0 0 24 24">
  ...
  {
    label: "Outcome", value: "Real startup internship",
    icon: (
      <svg width="14" height="14" fill="none" stroke="rgba(255,255,255,.5)" viewBox="0 0 24 24">
  ...
  {
    label: "Guarantee", value: "100% internship placement",
    icon: (
      <svg width="14" height="14" fill="none" stroke="rgba(255,255,255,.5)" viewBox="0 0 24 24">
...
function InlineApplyForm() {
  ...
  const [formData, setFormData] = useState({
    fullName: "", email: "", phone: PREFIX, highestDegree: "", graduationYear: "",
  });
  ...
  const reset = () => {
    setFormData({ fullName: "", email: "", phone: PREFIX, highestDegree: "", graduationYear: "" });
    setPhoneError(""); setEmailError(""); setUserCaptcha(""); setCaptchaError("");
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!validatePhone(formData.phone)) { setPhoneError("Invalid phone number"); return; }
    if (!validateEmail(formData.email)) { setEmailError("Enter a valid email");   return; }
    ...
    try {
      ...
      body.append("course", "-"); body.append("comment", "-"); body.append("address", "-");
      body.append("file",   "");  body.append("filename", "");
  ...
  return (
    <form onSubmit={handleSubmit} className="inline-apply-form"
      ...
      <div>
        ...
        <input type="email" name="email" required value={formData.email}
          ...
          style={{ ...inputStyle, borderColor: emailError ? "#f87171" : "rgba(255,255,255,0.12)" }} />
      ...
      <div>
        ...
        <input type="tel" name="phone" required value={formData.phone}
          onChange={handlePhoneChange} placeholder="+91 XXXXXXXXXX"
          style={{ ...inputStyle, borderColor: phoneError ? "#f87171" : "rgba(255,255,255,0.12)" }} />
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "10px" }}>
        <div>
          ...
          <input type="text" name="highestDegree" required value={formData.highestDegree}
            onChange={handleChange} placeholder="B.Tech, BCA..." style={inputStyle} />
        </div>
        <div>
          <label style={labelStyle}>Grad. Year *</label>
          <select name="graduationYear" required value={formData.graduationYear}
            onChange={handleChange} style={{ ...inputStyle, cursor: "pointer" }}>
            <option value="" disabled style={{ background: "#1c2030" }}>Year</option>
            {Array.from({ length: 10 }, (_, i) => 2025 + i).map((y) => (
              <option key={y} value={String(y)} style={{ background: "#1c2030" }}>{y}</option>
            ))}
          </select>
        </div>
      </div>
      ...
      <div className="dark-captcha-wrap">
        <Captcha ref={captchaRef} value={userCaptcha} onChange={setUserCaptcha}
          error={captchaError} onErrorClear={() => setCaptchaError("")} isOpen={true} />
      </div>
      ...
      <button type="submit" disabled={isSubmitting}
        style={{
          ...
          transition: "background 0.2s, color 0.2s", marginTop: "2px",
        }}>
        ...
        <div style={{
          ...
          <div style={{ padding: "clamp(20px, 5vw, 50px)" }}>
            ...
            <div style={{
              ...
              paddingBottom: "28px", borderBottom: "1px solid #e0dedd", marginBottom: "28px",
            }}>
              <div>
                <div style={{ display: "flex", alignItems: "center", gap: "7px", marginBottom: "12px" }}>
                  ...
                  <span style={{ fontSize: "12px", fontWeight: 800, color: "#e53e3e", letterSpacing: "0.02em" }}>15TH SEPTEMBER 2026</span>
                </div>
          ...
          <div className="flex dark-section" style={{
            background: "#1c2030",
            ...
            <div style={{ marginBottom: "18px" }}>
              <p style={{ fontSize: "20px", color: "rgba(255,255,255,0.9)", fontWeight: 800, margin: "0 0 6px" }}>
                Apply now to secure your spot!
              </p>
              <p style={{ fontSize: "16px", color: "rgba(255,255,255,0.5)", fontWeight: 500, margin: 0, letterSpacing: "0.02em" }}>
              ...
              {statItems.map((stat) => (
                <div key={stat.label} style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                  ...
                  <span className="stat-value" style={{
                    ...
                    color: "rgba(255,255,255,0.75)", fontWeight: 500, lineHeight: 1.3,
                  }}>
                    {stat.value}
                  </span>
                </div>
