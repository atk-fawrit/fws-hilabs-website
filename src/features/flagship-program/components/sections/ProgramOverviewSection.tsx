...
function TimerUnit({ value, label }: { value: number; label: string }) {
  return (
    <div className="flex flex-col items-center gap-1">
      <div className="bg-gray-950 text-white rounded-lg w-14 h-14 flex items-center justify-center font-mono text-xl font-bold tabular-nums shadow-sm">
        ...
        <div className="bg-white rounded-2xl shadow-2xl p-6 sm:p-8 md:p-10 lg:p-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-8 gap-10 items-start">
            ...
            <div className="lg:col-span-5">
              ...
              <div className="mb-7 p-5 rounded-xl border-2 border-red-100 bg-gradient-to-br from-red-50 to-orange-50 inline-block w-full sm:w-auto shadow-sm">
                {/* Badge row */}
