        ...
        <div className="grid lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7">
            ...
            >
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white tracking-tight mb-6 leading-tight font-sans">
                Frontend Developer <span className="text-white">(React)</span>
              </h1>
          ...
          <div className="lg:col-span-5">
            ...
            >
              ...
              Course starts: <span className="text-white font-medium">30 May 2026</span>
              </span>
              </div>
                ...
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm leading-relaxed text-white">Live lectures, project-based learning, code reviews, and portfolio development</p>
                  </div>
                </div>
              </div>
            </motion.div>
