/**
 * Admissions Feature Sections
 * 
 * Section components that compose the admissions page
 */

export { SelectionSystemSection } from './SelectionSystemSection';
export { EligibilityRequirementsSection } from './EligibilityRequirementsSection';
