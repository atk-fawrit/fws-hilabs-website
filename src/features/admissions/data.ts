...
export const admissionsData = {
  ...
  categories: [
    {
      ...
      description: '4 months training + internship full-time engineering talent production program with rigorous selection criteria',
  ...
  eligibility: {
    criteria: [
      ...
      'Ability to commit full-time for 4 months training + internship',
  ...
  selectionStages: [
    {
      ...
      components: [
        ...
        'Timeline confirmation for 4 months training + internship availability',
      ],
  ...
  commitments: [
    'Full-time participation for 4 months training + internship',
  ...
  risks: [
    ...
    'Career opportunity cost during 4 months training + internship commitment',
  ...
  shortCourses: {
    ...
    comparison: [
      ...
      { label: 'Duration', flagship: '4 months training + internship', shortCourse: '4-8 week/weekends' },
  ...
  checklist: [
    ...
    { key: 'availability', label: 'Confirmed 4 months training + internship availability and relocation capacity' },
