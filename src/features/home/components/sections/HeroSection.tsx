  ...
  return (
    <section ref={sectionRef} className="relative min-h-screen overflow-hidden bg-white">
      ...
      <div className="relative z-10 flex flex-col min-h-screen">
        ...
        {/* Pipeline Section */}
        <div className="flex-1 px-4 md:px-8 lg:px-12 pb-16">
          <div className="relative max-w-[1600px] mx-auto">
            <div className="relative z-10 py-10 px-6 md:px-10 lg:px-12">
                    ...
                    {stages.map((stage, index) => {
                      ...
                      return (
                        <div 
                          ...
                          style={{
                            zIndex: isCenter ? 50 : 40 - Math.abs(index - centerIndex),
                            transform: isVisible ? cardAnim.finalTransform : 'translateX(-50%)',
              ...
              {/* Header */}
              <div className="text-center">
                <h2 className="font-light text-4xl md:text-5xl lg:text-6xl mb-5 text-black tracking-tight">
