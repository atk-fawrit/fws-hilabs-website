      ...
      <div className="bg-[#1A1A1A] text-background py-16">
        <div className="px-8 md:px-12">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-20">
            <div>
              <h2 className="text-2xl font-bold mb-8 tracking-tight text-background">What HI Labs Is</h2>
              <ul className="space-y-5">
                <li className="flex items-start gap-4 group">
                  <span className="text-accent mt-1 text-sm flex-shrink-0">●</span>
                  <span className="text-background/85 text-base leading-relaxed group-hover:text-background transition-colors">
            ...
            <div>
              <h2 className="text-2xl font-bold mb-8 tracking-tight text-background">What HI Labs Is Not</h2>
              <ul className="space-y-5">
                <li className="flex items-start gap-4 group">
                  <span className="text-accent mt-1 text-sm flex-shrink-0">●</span>
                  <span className="text-background/85 text-base leading-relaxed group-hover:text-background transition-colors">
