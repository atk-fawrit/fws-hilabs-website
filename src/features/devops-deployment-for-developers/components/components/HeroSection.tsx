          ...
          <div className="lg:col-span-7">
            ...
            >
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white tracking-tight mb-6 leading-tight font-sans">
                DevOps & Deployment <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400">for Developers</span>
              </h1>
              ...
              <div className="space-y-6 text-slate-300">
                ...
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm leading-relaxed">Live instruction, lab-based exercises, infrastructure projects, and cloud deployments</p>
                  </div>
                </div>
              </div>
            </motion.div>
