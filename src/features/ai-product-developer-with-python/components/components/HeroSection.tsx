          ...
          <div className="lg:col-span-7">
            ...
            >
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white tracking-tight mb-6 leading-tight font-sans">
                AI Product Developer <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400">with Python</span>
              </h1>
              <p className="text-lg md:text-xl text-slate-300 mb-8 max-w-2xl leading-relaxed">
                Build intelligent AI-powered products and applications using cutting-edge tools and APIs.
              </p>
            ...
            >
                <div className="flex items-center justify-between mb-6 border-b border-slate-700 pb-4">
                  ...
                  <span className="text-sm text-slate-300">
                    Course starts: <span className="text-white font-medium">4 jul 2026</span>
                  </span>
                </div>             
                ...
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm leading-relaxed text-white">Live sessions, project-based labs, API integrations, and product demos</p>
                  </div>
                </div>
              </div>
            </motion.div>
