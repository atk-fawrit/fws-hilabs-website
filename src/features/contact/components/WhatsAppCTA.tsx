 ...
 * 
 * Call-to-action section for WhatsApp contact
 */
...
export const WhatsAppCTA: React.FC<WhatsAppCTAProps> = ({ onWhatsAppClick }) => {
  return (
    <motion.div
    ...
    >
      <div className="relative bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50 rounded-3xl p-10 shadow-lg border-2 border-green-100 overflow-hidden">
        ...
        <div className="relative z-10 text-center space-y-8">
          ...
          >
            <div className="w-24 h-24 bg-white rounded-3xl flex items-center justify-center mx-auto shadow-md border border-green-100">
          ...
          <div>
            ...
            <p className="text-gray-700 leading-relaxed font-light text-base">
              Have questions? Get instant responses through WhatsApp. We&apos;re here to help you with admissions, courses, and program details.
            </p>
          </div>
          ...
          <motion.button
            ...
            whileTap={{ scale: 0.95 }}
            className="inline-flex items-center justify-center gap-3 px-10 py-5 bg-green-600 text-white font-bold text-lg rounded-2xl shadow-lg hover:bg-green-700 transition-all duration-300"
          >
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/60 backdrop-blur-sm rounded-full border border-green-200">
            ...
            <span className="text-sm text-gray-700 font-medium">Available during business hours</span>
          </div>
        </div>
      </div>
    </motion.div>
