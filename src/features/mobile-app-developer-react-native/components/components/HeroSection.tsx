          ...
          <div className="lg:col-span-7">
            ...
            >
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white tracking-tight mb-6 leading-tight font-sans">
                Mobile App Developer <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400">(React Native)</span>
              </h1>
              <p className="text-lg md:text-xl text-slate-300 mb-8 max-w-2xl leading-relaxed">
                Create cross-platform mobile applications that run seamlessly on iOS and Android.
              </p>
            ...
            >
                ...
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm leading-relaxed text-white">Live sessions, hands-on app-building projects, and portfolio assessment</p>
                  </div>
                </div>
              </div>
            </motion.div>
