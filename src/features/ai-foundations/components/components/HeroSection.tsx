          ...
          <div className="lg:col-span-7">
            ...
            >
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white tracking-tight mb-6 leading-tight font-sans">
                AI <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400">Foundations</span>
              </h1>
            ...
            >
                <div className="flex items-center justify-between mb-6 border-b border-slate-700 pb-4">
                  ...
                  <span className="text-sm text-slate-300">
                    Course starts: <span className="text-white font-medium">23 may 2026</span>
                  </span>
                </div>              
