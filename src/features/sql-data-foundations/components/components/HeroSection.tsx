      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid lg:grid-cols-12 gap-12 items-center">
          <div className="lg:col-span-7">
            ...
            >
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white tracking-tight mb-6 leading-tight font-sans">
                SQL & Data <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-400">Foundations</span>
              </h1>
          ...
          <div className="lg:col-span-5">
            ...
            Course starts: <span className="text-white font-medium">16 May 2026</span>
            </span>
             </div>             
               <div className="space-y-6 text-slate-300">
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm leading-relaxed text-white">8 Weeks | Flexible scheduling available</p>
                  </div>
                </div>
                <div className="flex gap-4 items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm leading-relaxed text-white">Live instructor sessions, real-world database exercises, and project-based assessments</p>
                  </div>
                </div>
              </div>
            </motion.div>
