  ...
  return (
    <>
      ...
      `}
          ...
          {/* Mobile Actions (Phone, Mail, Hamburger) */}
          <div className="flex items-center gap-1 lg:hidden ml-auto">
            <a 
              href="tel:+917388899595" 
            ...
            <a 
              ...
              className="p-2 text-gray-500 hover:text-black transition-colors mr-1" 
              aria-label="Email us"
            >
              <svg className="w-5 h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="relative flex w-full overflow-hidden">
          <div className="animate-marquee hover:[animation-play-state:paused] whitespace-nowrap flex items-center text-[13px] font-medium tracking-wide">
            <div className="flex shrink-0">
               <span className="mx-8">📢 Admissions Open &nbsp;&bull;&nbsp; Limited Seats Available &nbsp;&bull;&nbsp; Next Batch Starts on 15th September 2026 &nbsp;&bull;&nbsp; Build Real AI Products &nbsp;&bull;&nbsp; <span className="text-[#7fc3ff] font-bold mx-1 text-[16px]">Apply Now</span> To Book You Seat! &nbsp;&bull;&nbsp; Contact us - 7388899595 / contact@thehilabs.com</span>
               <span className="mx-8">📢 Admissions Open &nbsp;&bull;&nbsp; Limited Seats Available &nbsp;&bull;&nbsp; Next Batch Starts on 15th September 2026 &nbsp;&bull;&nbsp; Build Real AI Products &nbsp;&bull;&nbsp; <span className="text-[#7fc3ff] font-bold mx-1 text-[16px]">Apply Now</span> To Book You Seat! &nbsp;&bull;&nbsp; Contact us - 7388899595 / contact@thehilabs.com</span>
            </div>
            <div className="flex shrink-0">
               <span className="mx-8">📢 Admissions Open &nbsp;&bull;&nbsp; Limited Seats Available &nbsp;&bull;&nbsp; Next Batch Starts on 15th September 2026 &nbsp;&bull;&nbsp; Build Real AI Products &nbsp;&bull;&nbsp; <span className="text-[#7fc3ff] font-bold mx-1 text-[16px]">Apply Now</span> To Book You Seat! &nbsp;&bull;&nbsp; Contact us - 7388899595 / contact@thehilabs.com</span>
