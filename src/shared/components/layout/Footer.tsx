            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  <p className="font-sans text-sm font-medium text-gray-700 mb-3">Locations</p>
                  <div className="flex flex-wrap gap-3 mb-4">
                    {locations.map((location) => (
                      <button
                        key={location.name}
                        onClick={() => handleLocationClick(location.name)}
                        className={`font-sans text-sm transition-all duration-200 cursor-pointer px-4 py-2 rounded-full border font-medium ${
                          selectedLocation === location.name 
                            ? 'bg-gray-900 text-white border-gray-900 shadow-sm' 
                            : 'bg-white text-gray-700 border-gray-300 hover:border-gray-900 hover:text-gray-900 hover:shadow-sm'
                        }`}
                      >
                        {location.name}
                      </button>
                  ...
                  {selectedLocation && selectedLocationData && (
                    <div className="bg-white rounded-md border border-gray-200 overflow-hidden shadow-sm max-w-xs">
                      <div className="p-2 bg-gray-50 border-b border-gray-200">
                        <div className="flex items-center justify-between">
                          <div className="flex-1 pr-2">
                            <h5 className="font-sans text-xs font-semibold text-gray-900">{selectedLocationData.fullName}</h5>
                            <p className="font-sans text-xs text-gray-600 mt-0.5 leading-tight">{selectedLocationData.address}</p>
                          </div>
                          <button
                      ...
                      <div className="h-32">
                        <iframe
                          ...
                          title={`Map of ${selectedLocationData.fullName}`}
                        />
                      </div>
                      <div className="p-1.5 bg-gray-50 border-t border-gray-200">
                        <a
                          href={`https://www.google.com/maps/search/?api=1&query=${encodeURIComponent(selectedLocationData.address)}`}
                          target="_blank"
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-sans text-sm font-medium text-gray-700 mb-1">Phone</p>
        ...
        <div className="w-full mx-auto px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16">
          <div className="flex flex-col md:flex-row items-center justify-between gap-6">
            ...
            <div className="flex gap-5 items-center">
              <Link href="https://www.youtube.com/@thehilabs" target="_blank" rel="noopener noreferrer" aria-label="YouTube" className="text-gray-400 hover:text-white transition-colors duration-200">
              ...
              <Link href="https://www.facebook.com/softwaretrainingandplacementinstitute" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="text-gray-400 hover:text-white transition-colors duration-200">
              ...
              <Link href="https://www.instagram.com/thehi_labs/" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="text-gray-400 hover:text-white transition-colors duration-200">
